...
(function($) {
  ...
  $.fn.jclock = function(options) {
    ...
    return this.each(function() {
      ...
      $this.daysAbbrvNames[3] = "Mie";
      $this.daysAbbrvNames[4] = "Jue";
      $this.daysAbbrvNames[5] = "Vie";
      $this.daysAbbrvNames[6] = "Sab";
      ...
      $this.monthsAbbrvNames[11] = "Dic";

      // %B
      $this.monthsFullNames = new Array(12);
      $this.monthsFullNames[0] = "Enero";
      $this.monthsFullNames[1] = "Febrero";
      $this.monthsFullNames[2] = "Marzo";
      $this.monthsFullNames[3] = "Abril";
      $this.monthsFullNames[4] = "Mayo";
      $this.monthsFullNames[5] = "Junio";
      $this.monthsFullNames[6] = "Julio";
      $this.monthsFullNames[7] = "Agosto";
      $this.monthsFullNames[8] = "Septiembre";
      $this.monthsFullNames[9] = "Octubre";
      $this.monthsFullNames[10] = "Noviembre";
      $this.monthsFullNames[11] = "Diciembre";
